...
\begin{figure}[htb]
  \centering
  \includegraphics[width=1.0\linewidth]{images/chapter4/braintree-comunicaiton.png}\hfill
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.6\linewidth]{images/chapter4/drop-in.png}\hfill
